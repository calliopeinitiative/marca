...
class File
{
    ...
    */
    ...
    /**
     * @ORM\OneToOne(targetEntity="Marca\GradebookBundle\Entity\Grade", inversedBy="file")
     */
    protected $grade;
    ...
    */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Marca\AssignmentBundle\Entity\AssignmentSubmission", mappedBy="file")
     */
    ...
    /**
     * Set submissionReviewed
     *
     * @param \Marca\AssignmentBundle\Entity\AssignmentSubmission $submissionReviewed
     * @return File
     */
    public function setSubmissionReviewed(\Marca\AssignmentBundle\Entity\AssignmentSubmission $submissionReviewed = null)
    {
        $this->submissionReviewed = $submissionReviewed;

        return $this;
    }

    /**
     * Get submissionReviewed
     *
